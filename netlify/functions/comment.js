...
const app = Waline({
  env: 'netlify',
  mailSubject: '{{parent.nick}}，您在「Blackbird」博客上的留言收到了回复',
  mailTemplate: `
    <div style="border-top:2px solid #12ADDB;box-shadow:0 1px 3px #AAAAAA;line-height:180%;padding:0 15px 12px;margin:50px auto;font-size:12px;">
      <h2 style="border-bottom:1px solid #DDD;font-size:14px;font-weight:normal;padding:13px 0 10px 8px;">        
        您在<a style="text-decoration:none;color: #12ADDB;" href="{{site.url}}" target="_blank">「Blackbird」</a>博客上的评论有了新的回复
      </h2>
  ...
  mailSubjectAdmin: '您的博客「io-oi.dev」收到了新评论',
  mailTemplateAdmin: `
    <div style="border-top:2px solid #12ADDB;box-shadow:0 1px 3px #AAAAAA;line-height:180%;padding:0 15px 12px;margin:50px auto;font-size:12px;">
      <h2 style="border-bottom:1px solid #DDD;font-size:14px;font-weight:normal;padding:13px 0 10px 8px;">        
        有人在您的博客<a style="text-decoration:none;color: #12ADDB;" href="{{site.url}}" target="_blank">「io-oi.dev」</a>上发表了新的评论
      </h2>
      <div style="padding:0 12px 0 12px;margin-top:18px">
